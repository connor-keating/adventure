...
clang++ %compiler_flags% %app_flags% main.cpp render_dx11.cpp raymarcher.cpp %code_files% -o %outdir%\%assembly%.exe %defines% %includes% %linker_flags% -L%OUTDIR% -l%plat_assembly%.lib
